...
export {default as ForTheHome} from './productsView/home'
export {default as Quantity} from './bag/quantity'
export {default as Confirmation} from './order/confirmation'
export {default as Gifting} from './gifting/gifting'
